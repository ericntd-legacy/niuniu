...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5269f71daf1f62_87847814',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5269f71daf1f62_87847814')) {function content_5269f71daf1f62_87847814($_smarty_tpl) {?><!-- block seach mobile -->
<!-- Block search module TOP -->
<div id="search_block_top">
	<form method="get" action="http://beta.niuniuboutique.com/tw/search" id="searchbox">
		<p>
			...
			<input type="submit" name="submit_search" value="搜尋" class="button" />
		</p>
	</form>
</div>
	...
	// <![CDATA[
		$('document').ready( function() {
			$("#search_query_top")
				.autocomplete(
					'http://beta.niuniuboutique.com/tw/search', {
						minChars: 3,
						max: 10,
						width: 500,
						selectFirst: false,
