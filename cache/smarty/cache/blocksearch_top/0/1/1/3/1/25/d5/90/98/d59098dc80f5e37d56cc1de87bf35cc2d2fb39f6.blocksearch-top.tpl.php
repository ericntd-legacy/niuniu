...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5269f77361d270_58466107',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5269f77361d270_58466107')) {function content_5269f77361d270_58466107($_smarty_tpl) {?><!-- block seach mobile -->
<!-- Block search module TOP -->
<div id="search_block_top">
	<form method="get" action="http://beta.niuniuboutique.com/zh/search" id="searchbox">
		<p>
	...
	// <![CDATA[
		$('document').ready( function() {
			$("#search_query_top")
				.autocomplete(
					'http://beta.niuniuboutique.com/zh/search', {
						minChars: 3,
						max: 10,
						width: 500,
						selectFirst: false,
