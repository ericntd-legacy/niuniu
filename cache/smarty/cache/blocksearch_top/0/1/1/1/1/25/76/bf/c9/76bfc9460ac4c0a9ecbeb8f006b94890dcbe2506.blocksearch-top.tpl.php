...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5280ec558846d5_81145847',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5280ec558846d5_81145847')) {function content_5280ec558846d5_81145847($_smarty_tpl) {?><!-- block seach mobile -->
<!-- Block search module TOP -->
<section id="search_block_top" class="header-box">
	<form method="get" action="http://localhost:8888/niuniu/en/search" id="searchbox">
		<p>
	...
	// <![CDATA[
		$('document').ready( function() {
			$("#search_query_top")
				.autocomplete(
					'http://localhost:8888/niuniu/en/search', {
						minChars: 3,
						max: 10,
						width: 300,
						selectFirst: false,
