<?php /* Smarty version Smarty-3.1.14, created on 2013-10-25 04:35:59
         compiled from "/var/www/html/niuniu/themes/fashionbird/manufacturer-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:747250501526984afabe0e9-23994832%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d227e131b4c563ddf4f03ccb184e534f5965a25' => 
    array (
      0 => '/var/www/html/niuniu/themes/fashionbird/manufacturer-list.tpl',
      1 => 1373170726,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '747250501526984afabe0e9-23994832',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526984afde4ce5_07177423',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526984afde4ce5_07177423')) {function content_526984afde4ce5_07177423($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.escape.php';
?>
...
<h1><span><?php echo smartyTranslate(array('s'=>'Manufacturers'),$_smarty_tpl);?>
</span></h1>
<?php if (isset($_smarty_tpl->tpl_vars['errors']->value)&&$_smarty_tpl->tpl_vars['errors']->value){?>
	<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./errors.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<?php }else{ ?>
	<p class="clearfix title_manuf"><span class="title_shop"><?php if ($_smarty_tpl->tpl_vars['nbManufacturers']->value==0){?><?php echo smartyTranslate(array('s'=>'There are no manufacturers.'),$_smarty_tpl);?>
...
-brand.jpg" alt="" />
                    ...
                    <div class="left_side">
					<h3>
						<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0){?><a class="product_link" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), 'htmlall', 'UTF-8');?>
"><?php }?>
					...
					<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0){?><p class="product_desc"><?php }?>
						<span><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['manufacturer']->value['description'],150,'...'), 'htmlall', 'UTF-8');?>
</span>
                       <em class="des-small"> <?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['manufacturer']->value['description'],80,'...'), 'htmlall', 'UTF-8');?>
</em>
				...
				<div class="right_side">
					<p>
					<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0){?><a class="title_shop" href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), 'htmlall', 'UTF-8');?>
"><?php }?>
