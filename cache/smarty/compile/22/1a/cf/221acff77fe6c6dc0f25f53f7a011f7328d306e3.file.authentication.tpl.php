<?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 11:36:31
         compiled from "/Applications/MAMP/htdocs/niuniu/themes/fashionbird/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:788130926526c8a3f81a489-82651769%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '221acff77fe6c6dc0f25f53f7a011f7328d306e3' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/themes/fashionbird/authentication.tpl',
      1 => 1382791380,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '788130926526c8a3f81a489-82651769',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526c8a3fde3003_50955199',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526c8a3fde3003_50955199')) {function content_526c8a3fde3003_50955199($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/niuniu/tools/smarty/plugins/modifier.escape.php';
?>
...
<h1><span><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)){?><?php echo smartyTranslate(array('s'=>'Log in'),$_smarty_tpl);?>
...
" method="post" id="create-account_form" class="std span6">
		<fieldset class="titled_box">
			...
			<div class="form_content clearfix">
				...
				<p class="text">
					...
					<span><input type="email" id="email_create" name="email_create" value="<?php if (isset($_POST['email_create'])){?><?php echo stripslashes($_POST['email_create']);?>
...
" />
	...
	<form action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true);?>
" method="post" id="login_form" class="std span6">
		<fieldset class="titled_box">
			...
			<div class="form_content clearfix">
				<p class="text">
					...
					<span><input type="email" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo stripslashes($_POST['email']);?>
<?php }?>" class="account_input" /></span>
				</p>
				<p class="text">
...
" />
                				...
                				<p class="lost_password"><a class="button " href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('password');?>
...
" method="post" id="new_account_form" class="std clearfix">
 ...
 <sup>*</sup></label>
					<input type="email" class="text" id="guest_email" name="guest_email" value="<?php if (isset($_POST['guest_email'])){?><?php echo $_POST['guest_email'];?>
<?php }?>" />
				</p>
...
" <?php if (($_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
 ...
 <sup>*</sup></label>
							<input type="tel" class="text" name="phone" id="phone" value="<?php if (isset($_POST['phone'])){?><?php echo $_POST['phone'];?>
<?php }?> "/>
						</p>
					<?php }?>
				<?php } ?>
...
<?php }?>" />
 ...
 <sup>*</sup></label>
			<input type="email" class="text" id="email" name="email" value="<?php if (isset($_POST['email'])){?><?php echo $_POST['email'];?>
<?php }?>" />
		</p>
		<p class="required password clearfix">
			<label for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup><span class="form_info"><?php echo smartyTranslate(array('s'=>'(5 characters min.)'),$_smarty_tpl);?>
</span></label>
...
<?php }?>" />
		...
		<p class="<?php if ($_smarty_tpl->tpl_vars['one_phone_at_least']->value){?>required <?php }?> text">
 ...
 <?php if ($_smarty_tpl->tpl_vars['one_phone_at_least']->value){?><sup>*</sup><?php }?></label>
			<input type="tel" class="text" name="phone_mobile" id="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])){?><?php echo $_POST['phone_mobile'];?>
<?php }?>" />
		</p>
...
<?php }?>" />
	...
	<fieldset class="account_creation dni">
		...
		<p class="required text">
			<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
			<input type="tel" class="text" name="dni" id="dni" value="<?php if (isset($_POST['dni'])){?><?php echo $_POST['dni'];?>
<?php }?>" />
			<span class="form_info"><?php echo smartyTranslate(array('s'=>'DNI / NIF / NIE'),$_smarty_tpl);?>
</span>
		</p>
