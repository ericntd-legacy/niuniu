<?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 15:13:33
         compiled from "/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/controllers/groups/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1851434225526cbd1d646e26-74496460%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd93bec9abb9bd4cf91baff7e77a617ffc57232bf' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/controllers/groups/helpers/form/form.tpl',
      1 => 1382764589,
      2 => 'file',
    ),
    'a05154d4ef803677a4da46d9cd5ec14a0d54b97f' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/helpers/form/form.tpl',
      1 => 1382764589,
      2 => 'file',
    ),
    '5f8949454680818d65c98bd0f6f48c8a31338c16' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/helpers/form/form_group.tpl',
      1 => 1382764589,
      2 => 'file',
    ),
    '4b5bf8a072b22b037cdeb5fa3af8cb19c1bb9b50' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/helpers/form/form_category.tpl',
      1 => 1382764589,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1851434225526cbd1d646e26-74496460',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526cbd1e1f5d15_14153345',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526cbd1e1f5d15_14153345')) {function content_526cbd1e1f5d15_14153345($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/niuniu/tools/smarty/plugins/modifier.escape.php';
?>
...
_form<?php }?>" class="defaultForm <?php echo $_smarty_tpl->tpl_vars['name_controller']->value;?>
...
" />
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='modules'){?>
		<div style="<?php if (!$_smarty_tpl->tpl_vars['form_id']->value){?>display:none<?php }?>">
			<div class="separation"></div>
			<label><?php echo smartyTranslate(array('s'=>'Module restrictions:'),$_smarty_tpl);?>
</label>
		</div>
	<?php }elseif($_smarty_tpl->tpl_vars['input']->value['type']=='group_discount_category'){?>
		<div style="<?php if (!$_smarty_tpl->tpl_vars['form_id']->value){?>display:none<?php }?>">
			<div class="separation"></div>
			<label><?php echo $_smarty_tpl->tpl_vars['input']->value['label'];?>
 </label>
		</div>
	<?php }else{ ?>
		<label><?php echo $_smarty_tpl->tpl_vars['input']->value['label'];?>
	...
	<div style="<?php if (!$_smarty_tpl->tpl_vars['form_id']->value){?>display:none<?php }?>">
		...
		function toogleCheck(elt)
		{
			if ($(elt).hasClass('select_all'))
			{
				...
				$(elt).html('<?php echo smartyTranslate(array('s'=>'Select all'),$_smarty_tpl);?>
');
			}
			else
			{
				...
				$(elt).html('<?php echo smartyTranslate(array('s'=>'Unselect all'),$_smarty_tpl);?>
');
			}
		}
		...
		function addCategoryReduction() 
		{
			...
			$('.category_reduction').each( function () {
				...
				{
					exist = true;
					jAlert('<?php echo smartyTranslate(array('s'=>'This category already exists for this group.','js'=>1),$_smarty_tpl);?>
');
					return false;
				}
			});
			...
			$.ajax({
				...
				data : {
					ajax: "1",
					token: "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminGroups'),$_smarty_tpl);?>
",
				...
				success : function(jsonData) {
					...
					{
						$('#group_discount_category_table').append('<tr class="alt_row" id="'+jsonData.id_category+'"><td>'+jsonData.catPath+'</td><td><?php echo smartyTranslate(array('s'=>'Discount:'),$_smarty_tpl);?>
'+jsonData.discount+'<?php echo smartyTranslate(array('s'=>'%'),$_smarty_tpl);?>
</td><td><a href="#" onclick="deleteCategoryReduction('+jsonData.id_category+');"><img src="../img/admin/delete.gif"></a></td></tr>');
		...
		<div class="margin-form">
			<a class="button" href="#group_discount_category_fancybox" id="group_discount_category"><?php echo smartyTranslate(array('s'=>'Add a category discount'),$_smarty_tpl);?>
</a>
...
">
		...
		<div style="display:none" id="group_discount_category_fancybox">
			<fieldset style="text-align:left"><legend><img src="../img/admin/tab-groups.gif" /><?php echo smartyTranslate(array('s'=>'New group category discount'),$_smarty_tpl);?>
</legend>
				<div class="hintGroup" style="font-size: 13px;">
					<?php echo smartyTranslate(array('s'=>'Caution: The discount applied to a category does not stack with the overall reduction but instead replaces it.'),$_smarty_tpl);?>

				</div>
				<?php echo $_smarty_tpl->tpl_vars['categoryTreeView']->value;?>

				<div class="warn"><?php echo smartyTranslate(array('s'=>'Only products that have this category as the default category will be affected.'),$_smarty_tpl);?>
</div>
				<div class="clear">&nbsp;</div>
				<label><?php echo smartyTranslate(array('s'=>'Discount (%):'),$_smarty_tpl);?>
</label>
				<input type="text" name="category_reduction_fancybox" id="category_reduction_fancybox" value="0.00" size="33">
				<div class="clear">&nbsp;</div>
				<button onclick="addCategoryReduction();" class="button"><?php echo smartyTranslate(array('s'=>'add'),$_smarty_tpl);?>
</button>
			</fieldset>
		</div>
	</div>
				...
				<thead>
					<tr>
						<th style="padding-left:10px;">
							<?php echo $_smarty_tpl->tpl_vars['input']->value['label']['auth_modules'];?>

						</th>
						<th style="padding-left:10px;">
							<?php echo $_smarty_tpl->tpl_vars['input']->value['label']['unauth_modules'];?>
 ...
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['auth_modules']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['module']->key => $_smarty_tpl->tpl_vars['module']->value){
$_smarty_tpl->tpl_vars['module']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['module']->key;
?>
									<li class="module_list" id="module_<?php echo $_smarty_tpl->tpl_vars['module']->value->id;?>
">
										<input type="checkbox" style="margin-right:5px">
										<img src="../modules/<?php echo $_smarty_tpl->tpl_vars['module']->value->name;?>
/logo.gif">
										<?php echo $_smarty_tpl->tpl_vars['module']->value->displayName;?>

										<input type="hidden" name="modulesBoxAuth[]" value="<?php echo $_smarty_tpl->tpl_vars['module']->value->id;?>
">
									</li>
						...
						<td style="width:300px">
							<ul id="sortable_module_unauthorize_list" class="connectedSortable" style="height:300px;overflow:auto">
								...
								<?php  $_smarty_tpl->tpl_vars['module'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['module']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['input']->value['values']['unauth_modules']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['module']->key => $_smarty_tpl->tpl_vars['module']->value){
$_smarty_tpl->tpl_vars['module']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['module']->key;
?>
...
/logo.gif">
										...
										<input type="hidden" name="modulesBoxUnauth[]" value="<?php echo $_smarty_tpl->tpl_vars['module']->value->id;?>
">
									</li>
								<?php } ?>
							</ul>
				...
				<tfoot>
					<tr>
						<td style="text-align:center">
							<button style="width:100%;margin-top:5px" id="authorize_list" onclick="toogleCheck(this);return false;" class="button"><?php echo smartyTranslate(array('s'=>'Select all'),$_smarty_tpl);?>
</button>
							<button style="width:100%;margin-top:5px;margin-bottom:5px" onclick="authorizeChecked();return false;" class="button"><?php echo smartyTranslate(array('s'=>'Unauthorize >>'),$_smarty_tpl);?>
</button>
						</td>
						<td style="text-align:center">
							<button style="width:100%;margin-top:5px"id="unauthorize_list" onclick="toogleCheck(this);return false;" class="button"><?php echo smartyTranslate(array('s'=>'Select all'),$_smarty_tpl);?>
</button>
							<button style="width:100%;margin-top:5px;margin-bottom:5px" onclick="unauthorizeChecked();return false;" class="button"><?php echo smartyTranslate(array('s'=>'<< Authorize'),$_smarty_tpl);?>
</button>
						</td>
					</tr>
				</tfoot>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1851434225526cbd1d646e26-74496460');
content_526cbd1dd25aa6_48100102($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_category.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('categories'=>$_smarty_tpl->tpl_vars['input']->value['values']), 0, '1851434225526cbd1d646e26-74496460');
content_526cbd1dd88db3_97585643($_smarty_tpl);
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 15:13:33
         compiled from "/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_526cbd1dd25aa6_48100102')) {function content_526cbd1dd25aa6_48100102($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 15:13:33
         compiled from "/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/helpers/form/form_category.tpl" */ ?>
<?php if ($_valid && !is_callable('content_526cbd1dd88db3_97585643')) {function content_526cbd1dd88db3_97585643($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/Applications/MAMP/htdocs/niuniu/tools/smarty/plugins/function.implode.php';
?>
