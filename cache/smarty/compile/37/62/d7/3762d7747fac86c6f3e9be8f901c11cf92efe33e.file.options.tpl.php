<?php /* Smarty version Smarty-3.1.14, created on 2013-10-27 10:23:17
         compiled from "/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/controllers/meta/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1376384250526c7915593e11-37382912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3762d7747fac86c6f3e9be8f901c11cf92efe33e' => 
    array (
      0 => '/Applications/MAMP/htdocs/niuniu/admin1/themes/default/template/controllers/meta/helpers/options/options.tpl',
      1 => 1382764589,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1376384250526c7915593e11-37382912',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526c7915c37da5_98411784',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526c7915c37da5_98411784')) {function content_526c7915c37da5_98411784($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Applications/MAMP/htdocs/niuniu/tools/smarty/plugins/modifier.escape.php';
...
')" />
	...
	<?php if ($_smarty_tpl->tpl_vars['field']->value['type']=='rewriting_settings'){?>
...
_off"> <?php echo smartyTranslate(array('s'=>'No'),$_smarty_tpl);?>
		...
		<?php if (!$_smarty_tpl->tpl_vars['field']->value['mod_rewrite']){?>
			<span class="warning_mod_rewrite"><?php echo smartyTranslate(array('s'=>'URL rewriting (mod_rewrite) is not active on your server, or it is not possible to check your server configuration. If you want to use Friendly URLs, you must activate this mod.'),$_smarty_tpl);?>
</span>
			<div class="clear"></div>
		<?php }?>
	<?php }else{ ?>
