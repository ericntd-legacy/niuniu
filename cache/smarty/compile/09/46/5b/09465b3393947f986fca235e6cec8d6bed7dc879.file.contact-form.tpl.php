<?php /* Smarty version Smarty-3.1.14, created on 2013-10-25 04:41:22
         compiled from "/var/www/html/niuniu/themes/fashionbird/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:908605234526985f2853330-10745592%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09465b3393947f986fca235e6cec8d6bed7dc879' => 
    array (
      0 => '/var/www/html/niuniu/themes/fashionbird/contact-form.tpl',
      1 => 1373170726,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '908605234526985f2853330-10745592',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526985f2c7dd21_28231282',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526985f2c7dd21_28231282')) {function content_526985f2c7dd21_28231282($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.escape.php';
?>
...
<h1><span><?php echo smartyTranslate(array('s'=>'Customer Service'),$_smarty_tpl);?>
...
<?php if (isset($_smarty_tpl->tpl_vars['confirmation']->value)){?>
	<p class="success"><i class="icon-ok"></i><?php echo smartyTranslate(array('s'=>'Your message has been successfully sent to our team.'),$_smarty_tpl);?>
</p>
...
<?php }else{ ?>
	<p class="title-pagecontact"><i class="icon-comment-alt"></i><?php echo smartyTranslate(array('s'=>'For questions about an order or for more information about our products'),$_smarty_tpl);?>
.</p>
	<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./errors.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	<form id="contact_form" action="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['request_uri']->value, 'htmlall', 'UTF-8');?>
" method="post" class="std" enctype="multipart/form-data">
		<fieldset class="titled_box">
			<h2><span><?php echo smartyTranslate(array('s'=>'send a message'),$_smarty_tpl);?>
</span></h2>
			<p class="select">
...
" class="desc_contact" style="display:none;">
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])){?>
					<input type="email" id="email" name="from" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['customerThread']->value['email'], 'htmlall', 'UTF-8');?>
" readonly="readonly" />
				<?php }else{ ?>
					<input type="email" id="email" name="from" value="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['email']->value, 'htmlall', 'UTF-8');?>
" />
				<?php }?>
			</p>
...
_order_products" class="product_select" style="<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?> display:none; <?php }?>" <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['products']['first']){?>disabled="disabled" <?php }?>>
						<option value="0"><?php echo smartyTranslate(array('s'=>'-- Choose --'),$_smarty_tpl);?>
</option>
...
<?php }?></textarea>
		...
		<p class="submit">
			<input  class="button" type="submit" name="submitMessage" id="submitMessage" value="<?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
