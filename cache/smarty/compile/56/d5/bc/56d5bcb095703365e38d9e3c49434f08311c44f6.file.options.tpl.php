<?php /* Smarty version Smarty-3.1.14, created on 2013-10-25 11:39:07
         compiled from "/var/www/html/niuniu/admin1/themes/default/template/controllers/themes/helpers/options/options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9429265055269e7db48c8f7-53344490%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56d5bcb095703365e38d9e3c49434f08311c44f6' => 
    array (
      0 => '/var/www/html/niuniu/admin1/themes/default/template/controllers/themes/helpers/options/options.tpl',
      1 => 1377677662,
      2 => 'file',
    ),
    'c93912e009ad5ce3efbef262a75ae363ed77bdee' => 
    array (
      0 => '/var/www/html/niuniu/admin1/themes/default/template/helpers/options/options.tpl',
      1 => 1377677662,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9429265055269e7db48c8f7-53344490',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5269e7dbce98f8_02652445',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5269e7dbce98f8_02652445')) {function content_5269e7dbce98f8_02652445($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.replace.php';
?>
...
')" />
 ...
 $_from = $_smarty_tpl->tpl_vars['field']->value['themes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['theme']->key => $_smarty_tpl->tpl_vars['theme']->value){
$_smarty_tpl->tpl_vars['theme']->_loop = true;
?>
				<div class="select_theme <?php if ($_smarty_tpl->tpl_vars['theme']->value->id==$_smarty_tpl->tpl_vars['field']->value['id_theme']){?>select_theme_choice<?php }?>" onclick="$(this).find('input').attr('checked', true); $('.select_theme').removeClass('select_theme_choice'); $(this).toggleClass('select_theme_choice');">
					<?php echo $_smarty_tpl->tpl_vars['theme']->value->name;?>
<br />
					<img src="../themes/<?php echo $_smarty_tpl->tpl_vars['theme']->value->directory;?>
/preview.jpg" alt="<?php echo $_smarty_tpl->tpl_vars['theme']->value->directory;?>
" /><br />
					<input type="radio" name="id_theme" value="<?php echo $_smarty_tpl->tpl_vars['theme']->value->id;?>
" <?php if ($_smarty_tpl->tpl_vars['theme']->value->id==$_smarty_tpl->tpl_vars['field']->value['id_theme']){?>checked="checked"<?php }?> />
				</div>
			<?php } ?>
		<?php }?>
	<?php }else{ ?>
...
',
				...
				$("#prestastore-content").html("<legend><img src='../img/admin/prestastore.gif' class='middle' /><?php echo smartyTranslate(array('s'=>'Live from PrestaShop Addons!'),$_smarty_tpl);?>
</legend>"+a);
			});
	</script>
