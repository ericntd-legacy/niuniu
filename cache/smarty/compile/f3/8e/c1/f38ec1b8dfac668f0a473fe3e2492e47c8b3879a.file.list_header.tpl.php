<?php /* Smarty version Smarty-3.1.14, created on 2013-10-13 12:19:57
         compiled from "/var/www/html/niuniu/admin1/themes/default/template/controllers/customers/helpers/list/list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1954030008525a1f6d34af12-02827137%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f38ec1b8dfac668f0a473fe3e2492e47c8b3879a' => 
    array (
      0 => '/var/www/html/niuniu/admin1/themes/default/template/controllers/customers/helpers/list/list_header.tpl',
      1 => 1377677661,
      2 => 'file',
    ),
    'beadb12851fa645396e55975d4a67eab649cd140' => 
    array (
      0 => '/var/www/html/niuniu/admin1/themes/default/template/helpers/list/list_header.tpl',
      1 => 1377677662,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1954030008525a1f6d34af12-02827137',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_525a1f6d8927b2_86209295',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_525a1f6d8927b2_86209295')) {function content_525a1f6d8927b2_86209295($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.escape.php';
?>
...
" method="post">
			<div class="warn">
				<h2><?php echo smartyTranslate(array('s'=>'How do you want to delete these customer(s)?'),$_smarty_tpl);?>
</h2>
				...
				<li>
					...
					<label for="deleteMode_real" style="float:none;"><?php echo smartyTranslate(array('s'=>'I want to delete my customer(s) (All data will be removed from the database, and customers with the same e-mail address will be able to re-register.'),$_smarty_tpl);?>
</label>
				</li>
				<li>
					<input type="radio" name="deleteMode" value="deleted" id="deleteMode_deleted" />
					<label for="deleteMode_deleted" style="float:none"><?php echo smartyTranslate(array('s'=>'I don\'t want my customer(s) to register again. Therefore, each customer(s) will be removed from this list but all corresponding data will be kept in the database.'),$_smarty_tpl);?>
</label>
				</li>
				</ul>
...
" />
					<?php }?>
				<?php } ?>
				<br /><input type="submit" class="button" value="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
" />
			</div>
		</form>
		<div class="clear">&nbsp;</div>
...
<?php if ($_smarty_tpl->tpl_vars['submit_form_ajax']->value){?>
	<script type="text/javascript">
		$('#customer', window.parent.document).val('<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['new_customer']->value->email, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
');
