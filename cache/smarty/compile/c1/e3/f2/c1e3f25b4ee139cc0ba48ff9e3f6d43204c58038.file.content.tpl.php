<?php /* Smarty version Smarty-3.1.14, created on 2013-10-26 12:10:33
         compiled from "/var/www/html/niuniu/admin1/themes/default/template/controllers/login/content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1822217524526b40b9b56e66-00839321%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1e3f25b4ee139cc0ba48ff9e3f6d43204c58038' => 
    array (
      0 => '/var/www/html/niuniu/admin1/themes/default/template/controllers/login/content.tpl',
      1 => 1377677661,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1822217524526b40b9b56e66-00839321',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_526b40ba019c98_81344859',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_526b40ba019c98_81344859')) {function content_526b40ba019c98_81344859($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/html/niuniu/tools/smarty/plugins/modifier.escape.php';
...
<?php if (!isset($_smarty_tpl->tpl_vars['wrong_folder_name']->value)&&!isset($_smarty_tpl->tpl_vars['wrong_install_name']->value)){?>
						<form action="#" id="login_form" method="post">
							<div class="field">
								...
								<input type="text" id="email" name="email" class="input email_field" tabindex="1" value="<?php if (isset($_smarty_tpl->tpl_vars['email']->value)){?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['email']->value, 'htmlall', 'UTF-8');?>
<?php }?>" />
							</div>					
							<div class="field">
								<label for="passwd"><?php echo smartyTranslate(array('s'=>'Password:'),$_smarty_tpl);?>
</label>
								<input id="passwd" type="password" name="passwd" class="input password_field" tabindex="2" value="<?php if (isset($_smarty_tpl->tpl_vars['password']->value)){?><?php echo $_smarty_tpl->tpl_vars['password']->value;?>
<?php }?>"/>
							</div>					
							<div class="field">
								<input type="submit" name="submitLogin" value="<?php echo smartyTranslate(array('s'=>'Log in'),$_smarty_tpl);?>
" tabindex="3" class="button fl margin-right-5" />					
